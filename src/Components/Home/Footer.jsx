    ...
    <div className=" py-5 md:py-14 lg:px-32 px-5  ">
      <div className="flex flex-col sm:flex-row justify-between gap-8 py-10 border-t-2 sm:items-start items-center lg:pr-[81px]">
        <div className="flex flex-col items-center justify-center sm:justify-start min-w-[200px] gap-4 ">
          ...
          <div class="font-medium capitalize text-sm md:text-base md:leading-[22.4px] sm:items-start sm:justify-start grid grid-cols-2 gap-x-8 gap-y-2 items-center justify-center">
            <div>
              <a href="/">Home</a>
            </div>
            <div>
        ...
        <div class="flex flex-col items-center justify-center sm:justify-start min-w-[200px] gap-4 ">
          <div class="text-base text-primaryColor leading-[22.4px] ">
            Company
          </div>
          <div class="font-medium capitalize text-sm md:text-base md:leading-[22.4px] sm:items-start sm:justify-start grid grid-cols-2 gap-x-8 gap-y-2 items-center justify-center">
            <div>
        ...
        <div class="flex flex-col items-center sm:items-start justify-center sm:justify-start gap-4 ">
          <div class="text-base text-primaryColor text-center leading-[22.4px] ">
            Socials
          </div>
          <div class="font-medium capitalize text-sm md:text-base md:leading-[22.4px] sm:items-start sm:justify-start flex items-center justify-center gap-6">
            <div>
              <svg
                width="1em"
                height="1em"
                ...
                class="h-6 w-6"
              >
                <g clip-path="url(#facebook1_svg__a)">
                  <path
            ...
            <div>
              <svg
                ...
                class="h-6 w-6"
              >
                <g clip-path="url(#instagram1_svg__a)" fill="#1E1E1E">
            ...
            <div>
              <svg
                ...
                class="h-6 w-6"
              >
                <g clip-path="url(#tiktok1_svg__a)">
                  <path
            ...
            <div>
              <svg
                ...
                class="h-6 w-6"
              >
                <g clip-path="url(#twitter1_svg__a)">
                  <path
      ...
      <div class="md:py-14 xl:pr-20 ">
        <div class="flex items-center flex-col-reverse lg:flex-row justify-center lg:justify-between">
          <div class="flex flex-col items-center lg:items-start justify-center lg:justify-start gap-8">
            <div class="relative w-[169px] h-[40px]">
                <img src="https://medhavhi.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-name.e436e18b.png&w=256&q=75" alt="company-logo" />
            </div>
            <div class="flex flex-col xl:flex-row md:gap-8 items-center text-[#0C0C0C] text-xs md:text-[15px] md:leading-[21px]">
              <div class="mb-8 md:mb-0">
                © 2023 Medhavhi. All right reserved.
              </div>
              <div class="flex flex-col sm:flex-row sm:gap-8 items-center">
                <div class="mb-4 sm:mb-0 text-[#7D7D7D]">
          ...
          <div class="flex w-full lg:w-fit justify-center lg:justify-start my-8 items-center lg:items-start flex-col gap-4 lg:gap-6">
            <p class="font-medium capitalize text-base leading-[22.4px]">
              Stay Informed with our Newsletter
            </p>
            <form class="w-full sm:w-fit relative flex items-center">
              <input
                type="text"
                name="email"
                placeholder="Enter your email address"
                class=" rounded-full w-full px-6 bg-[#F4F4F5] text-sm placeholder:text-[#71717A] py-4 sm:w-[600px] lg:w-[400px] outline-none focus:outline-none"
              />
